...
const HX_BASELINE_PAST = {
    medical:  ['Hypertension', 'Diabetes Mellitus', 'Ischemic Heart Disease', 'Asthma', 'CKD', 'Polycystic Kidney Disease', 'Glomerulonephritis'],
    surgical: ['Appendectomy', 'Cholecystectomy', 'Renal Transplant', 'AV Fistula Creation'],
    drug:     [],
    family:   ['Diabetes Mellitus', 'Hypertension', 'Malignancy', 'Polycystic Kidney Disease'],
